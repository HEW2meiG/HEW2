...
def identification():
    ...
    form = IdentificationForm(request.form, pref01 = useradress.prefecture, b_year=userinfo.birth.strftime('%Y'), b_month=userinfo.birth.strftime('%m'), b_date=userinfo.birth.strftime('%d')) #TODO: ←月・日のデフォルト値も設定
